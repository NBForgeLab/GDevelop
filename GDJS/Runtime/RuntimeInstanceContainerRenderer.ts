...
namespace gdjs {
   ...
   */
  export interface RuntimeInstanceContainerRendererInterface {
    /**
    ...
    getRendererObject(): gdjs.RendererObjectInterface | null;
  ...
  export type RuntimeInstanceContainerRenderer =
    gdjs.RuntimeInstanceContainerRendererInterface;
}
