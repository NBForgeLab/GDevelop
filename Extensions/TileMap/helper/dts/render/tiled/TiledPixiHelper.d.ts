...
export declare namespace TiledPixiHelper {
     ...
     */
    function parseAtlas(tileMap: TiledTileMap, levelIndex: number, atlasTexture: PIXI.TextureSource | null, getTexture: (textureName: string) => PIXI.TextureSource): TileTextureCache | null;
}
