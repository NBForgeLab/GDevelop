...
export declare namespace PixiTileMapHelper {
     ...
     */
    function parseAtlas(tileMap: TileMapFileContent, levelIndex: number, atlasTexture: PIXI.TextureSource | null, getTexture: (textureName: string) => PIXI.TextureSource): TileTextureCache | null;
    /**
     * Split an atlas image into Pixi textures.
     *
     * @param atlasTexture The texture containing the whole tile set.
     ...
     * @returns A textures cache.
     */
    function parseSimpleTileMapAtlas(atlasTexture: PIXI.TextureSource, columnCount: number, rowCount: number, tileSize: number): TileTextureCache;
    /**
