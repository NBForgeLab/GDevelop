declare namespace Jolt {
    ...
    class CompoundShapeSettings extends ShapeSettings {
        ...
        AddShapeShapeSettings(inPosition: Vec3, inRotation: Quat, inShape: ShapeSettings, inUserData: number): void;
        AddShapeShape(inPosition: Vec3, inRotation: Quat, inShape: Shape, inUserData: number): void;
    }
    ...
    class SoftBodySharedSettings {
        ...
        set_mRodStretchShearConstraints(mRodStretchShearConstraints: ArraySoftBodySharedSettingsRodStretchShear): void;
        ...
        set_mRodBendTwistConstraints(mRodBendTwistConstraints: ArraySoftBodySharedSettingsRodBendTwist): void;
